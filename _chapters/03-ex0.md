...
If you like your browsers so much, it is a great news for you: your browsers could be used as an IDE to code Julia. Here are some promising projects:

-   [JuliaBox](https://www.juliabox.org/): Julia core team is the person behind this project. It allows you to program, store, share your work with other people. However, it is still in _beta_ and mainly used for MIT classes so there are some limitation for our use. Nonetheless, never mind, it is [open source project](https://github.com/JuliaLang/JuliaBox) so why don't we could clone the source, set up for our cloud server and use it wherever we want?
-   [Jupyter](http://jupyter.org/): It is the project of IPython team to create an environment for Julia, Python and R programmers on the web. Its service named [CoLaboratory](http://colaboratory.jupyter.org) is Chrome app which allows you to run your code in Chrome. Similarly to JuliaBox, its [source code](https://github.com/jupyter/colaboratory/) is also open too. If it does not convince, check out the [tutorial](http://heike.github.io/stat590f/ijulia/#/) for more details.
