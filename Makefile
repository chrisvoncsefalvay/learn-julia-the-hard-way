...
FRONT_MATTER_FILES = CONTRIBUTORS.md
...
$(TITLE).pdf : $(FRONT_MATTER_FILES) $(CHAPTER_FILES)
	pandoc --latex-engine=xelatex --mathjax -s -o $(TITLE).pdf $(FRONT_MATTER_FILES) $(CHAPTER_FILES)

$(TITLE).epub : $(FRONT_MATTER_FILES) $(CHAPTER_FILES)
	pandoc --mathjax -s -o $(TITLE).epub $(FRONT_MATTER_FILES) $(CHAPTER_FILES)

$(TITLE).html : $(FRONT_MATTER_FILES) $(CHAPTER_FILES)
	pandoc --mathjax -s -o $(TITLE).html $(FRONT_MATTER_FILES) $(CHAPTER_FILES)
